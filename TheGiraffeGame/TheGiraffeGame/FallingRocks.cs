...
//            Unit Dwarf = new Unit();
//            Dwarf.x = 6;
//            Dwarf.y = (Console.WindowHeight / 2) - 1;
...
//                    newBuff.x = Console.WindowWidth;
//                    newBuff.y = randomGenerator.Next(0, Console.WindowHeight - 2);
...
//                    newInitRock.x = Console.WindowWidth;
//                    newInitRock.y = randomGenerator.Next(0, Console.WindowHeight - 2);
...
//                    NewMovedRock.x = oldRock.x - 1;
//                    NewMovedRock.y = oldRock.y;
...
//                        }
//                    }
//                    if (NewMovedRock.x < Console.WindowWidth)
//                    {
...
//                {
//                    PrintAtPosition(5, i, '|', ConsoleColor.Gray);
//                }
